...
def plot_all_visualizations(y_true_list, y_scores_list, y_pred_list):
    ...
    plt.savefig(f"./images/{config.ALGORITHM}/{config.PREDICTION_FILENAME}_precision_recall_curve.svg",
                format="svg")
    plt.show()
    ...
    plt.savefig(f"./images/{config.ALGORITHM}/{config.PREDICTION_FILENAME}_confusion_matrix.svg", format="svg")
    plt.show()
    ...
    plt.savefig(f"./images/{config.ALGORITHM}/{config.PREDICTION_FILENAME}_performance_metrics.svg",
                format="svg")
    plt.ylim(0, 1)
